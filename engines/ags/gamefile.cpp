...
bool GameFile::init(const ResourceManager &resMan) {
	...
	debug(2,
	      "%d views, %d characters, %d player characters, %d inventory items, "
	      "%d dialog topics",
...
InteractionVariable
GameFile::readInteractionVariable(Common::SeekableReadStream *dta) {
...
GameFile::readCommandList(Common::SeekableReadStream *dta) {
