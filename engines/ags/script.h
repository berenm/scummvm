...
struct RuntimeValue {
	...
	RuntimeValue(ScriptObject *obj) :
	    _type(rvtSystemObject), _value(0), _object(obj) {
		_object->IncRef();
	}
	~RuntimeValue() {
...
protected:
	...
	RuntimeValue callImportedFunction(const ScriptSystemFunctionInfo *function,
	                                  ScriptObject *object,
