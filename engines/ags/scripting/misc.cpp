...
RuntimeValue Script_Debug(AGSEngine *vm, ScriptObject *,
...
RuntimeValue Script_RunAGSGame(AGSEngine *vm, ScriptObject *,
                               const Common::Array<RuntimeValue> &params) {
...
// Undocumented.
RuntimeValue Script_InventoryScreen(AGSEngine *vm, ScriptObject *,
                                    const Common::Array<RuntimeValue> &params) {
	// FIXME
...
RuntimeValue
Script_AreThingsOverlapping(AGSEngine *vm, ScriptObject *,
                            const Common::Array<RuntimeValue> &params) {
...
RuntimeValue Script_SetTimer(AGSEngine *vm, ScriptObject *,
                             const Common::Array<RuntimeValue> &params) {
	uint timerID = params[0]._value;
	int timeout = params[1]._signedValue;

	if (timerID >= vm->_state->_scriptTimers.size())
		error("SetTimer: timer %d is too high (only have %d)", timerID,
		      vm->_state->_scriptTimers.size());
...
RuntimeValue Script_IsTimerExpired(AGSEngine *vm, ScriptObject *,
                                   const Common::Array<RuntimeValue> &params) {
	uint timerID = params[0]._value;
...
// Sets whether the game can continue to run in the background if the player
// switches to another application.
RuntimeValue
Script_SetMultitaskingMode(AGSEngine *vm, ScriptObject *,
                           const Common::Array<RuntimeValue> &params) {
...
// Checks whether an event handler is registered to handle clicking at the
// specified location on the screen.
RuntimeValue
Script_IsInteractionAvailable(AGSEngine *vm, ScriptObject *,
                              const Common::Array<RuntimeValue> &params) {
...
RuntimeValue Script_Wait(AGSEngine *vm, ScriptObject *,
                         const Common::Array<RuntimeValue> &params) {
...
RuntimeValue Script_StartCutscene(AGSEngine *vm, ScriptObject *,
                                  const Common::Array<RuntimeValue> &params) {
...
RuntimeValue Script_ClaimEvent(AGSEngine *vm, ScriptObject *,
                               const Common::Array<RuntimeValue> &params) {
	// FIXME
...
// import int ShellExecute(const string operation, const string file, const
// string parameters, ShowCommand showCommand = SW_SHOW); From the ags_shell.dll
// plugin.
RuntimeValue Script_ShellExecute(AGSEngine *vm, ScriptObject *,
                                 const Common::Array<RuntimeValue> &params) {
	...
	warning("attempted to call ShellExecute('%s', '%s', '%s', %d)",
	        operation->getString().c_str(), file->getString().c_str(),
...
RuntimeValue
Script_System_get_CapsLock(AGSEngine *vm, ScriptObject *,
                           const Common::Array<RuntimeValue> &params) {
	// FIXME
...
RuntimeValue
Script_System_get_NumLock(AGSEngine *vm, ScriptObject *,
                          const Common::Array<RuntimeValue> &params) {
	// FIXME
...
RuntimeValue
Script_System_get_ScrollLock(AGSEngine *vm, ScriptObject *,
                             const Common::Array<RuntimeValue> &params) {
	// FIXME
...
RuntimeValue Script_System_get_SupportsGammaControl(
    AGSEngine *vm, ScriptObject *, const Common::Array<RuntimeValue> &params) {
	// FIXME
...
RuntimeValue
Script_System_get_Version(AGSEngine *vm, ScriptObject *,
                          const Common::Array<RuntimeValue> &params) {
	// FIXME
...
RuntimeValue
Script_System_get_VSync(AGSEngine *vm, ScriptObject *,
                        const Common::Array<RuntimeValue> &params) {
	// FIXME
...
// Gets/sets whether waiting for the vertical sync is enabled.
RuntimeValue
Script_System_set_VSync(AGSEngine *vm, ScriptObject *,
                        const Common::Array<RuntimeValue> &params) {
...
static const ScriptSystemFunctionInfo ourFunctionList[] = {
    ...
    {"InventoryScreen", (ScriptAPIFunction *) &Script_InventoryScreen, "",
     sotNone},
    {"AreThingsOverlapping", (ScriptAPIFunction *) &Script_AreThingsOverlapping,
     "ii", sotNone},
    {"SetTimer", (ScriptAPIFunction *) &Script_SetTimer, "ii", sotNone},
    {"IsTimerExpired", (ScriptAPIFunction *) &Script_IsTimerExpired, "i",
     sotNone},
    {"SetMultitaskingMode", (ScriptAPIFunction *) &Script_SetMultitaskingMode,
     "i", sotNone},
    {"IsInteractionAvailable",
     (ScriptAPIFunction *) &Script_IsInteractionAvailable, "iii", sotNone},
    {"Wait", (ScriptAPIFunction *) &Script_Wait, "i", sotNone},
    {"SkipUntilCharacterStops",
     (ScriptAPIFunction *) &Script_SkipUntilCharacterStops, "i", sotNone},
    {"StartCutscene", (ScriptAPIFunction *) &Script_StartCutscene, "i",
     sotNone},
    {"EndCutscene", (ScriptAPIFunction *) &Script_EndCutscene, "", sotNone},
    {"ClaimEvent", (ScriptAPIFunction *) &Script_ClaimEvent, "", sotNone},
    {"ShellExecute", (ScriptAPIFunction *) &Script_ShellExecute, "sssi",
     sotNone},
    {"System::get_CapsLock", (ScriptAPIFunction *) &Script_System_get_CapsLock,
     "", sotNone},
    ...
    {"System::get_ColorDepth",
     (ScriptAPIFunction *) &Script_System_get_ColorDepth, "", sotNone},
    {"System::get_Gamma", (ScriptAPIFunction *) &Script_System_get_Gamma, "",
     sotNone},
    {"System::set_Gamma", (ScriptAPIFunction *) &Script_System_set_Gamma, "i",
     sotNone},
    {"System::get_HardwareAcceleration",
     (ScriptAPIFunction *) &Script_System_get_HardwareAcceleration, "",
     sotNone},
    {"System::get_NumLock", (ScriptAPIFunction *) &Script_System_get_NumLock,
     "", sotNone},
    {"System::get_OperatingSystem",
     (ScriptAPIFunction *) &Script_System_get_OperatingSystem, "", sotNone},
    {"System::get_ScreenHeight",
     (ScriptAPIFunction *) &Script_System_get_ScreenHeight, "", sotNone},
    {"System::get_ScreenWidth",
     (ScriptAPIFunction *) &Script_System_get_ScreenWidth, "", sotNone},
    {"System::get_ScrollLock",
     (ScriptAPIFunction *) &Script_System_get_ScrollLock, "", sotNone},
    {"System::get_SupportsGammaControl",
     (ScriptAPIFunction *) &Script_System_get_SupportsGammaControl, "",
     sotNone},
    {"System::get_Version", (ScriptAPIFunction *) &Script_System_get_Version,
     "", sotNone},
    {"System::get_ViewportHeight",
     (ScriptAPIFunction *) &Script_System_get_ViewportHeight, "", sotNone},
    {"System::get_ViewportWidth",
     (ScriptAPIFunction *) &Script_System_get_ViewportWidth, "", sotNone},
    {"System::get_Volume", (ScriptAPIFunction *) &Script_System_get_Volume, "",
     sotNone},
    {"System::set_Volume", (ScriptAPIFunction *) &Script_System_set_Volume, "i",
     sotNone},
    {"System::get_VSync", (ScriptAPIFunction *) &Script_System_get_VSync, "",
     sotNone},
    {"System::set_VSync", (ScriptAPIFunction *) &Script_System_set_VSync, "i",
     sotNone},
    {"System::get_Windowed", (ScriptAPIFunction *) &Script_System_get_Windowed,
     "", sotNone},
};
