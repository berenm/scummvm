...
void addMiscSystemScripting(AGSEngine *vm) {
	...
	state->addSystemFunctionImport("File::ReadInt^0",
	                               &Script_UnimplementedStub);
	state->addSystemFunctionImport("File::ReadRawChar^0",
	                               &Script_UnimplementedStub);
	state->addSystemFunctionImport("File::ReadRawInt^0",
	                               &Script_UnimplementedStub);
	state->addSystemFunctionImport("File::ReadRawLine^1",
	                               &Script_UnimplementedStub);
	state->addSystemFunctionImport("File::ReadRawLineBack^0",
	                               &Script_UnimplementedStub);
	state->addSystemFunctionImport("File::ReadString^1",
	                               &Script_UnimplementedStub);
	state->addSystemFunctionImport("File::ReadStringBack^0",
	                               &Script_UnimplementedStub);
	state->addSystemFunctionImport("File::WriteInt^1",
	                               &Script_UnimplementedStub);
	state->addSystemFunctionImport("File::WriteRawChar^1",
	                               &Script_UnimplementedStub);
	state->addSystemFunctionImport("File::WriteRawLine^1",
	                               &Script_UnimplementedStub);
	state->addSystemFunctionImport("File::WriteString^1",
	                               &Script_UnimplementedStub);
	state->addSystemFunctionImport("File::get_EOF", &Script_UnimplementedStub);
	state->addSystemFunctionImport("File::get_Error",
	                               &Script_UnimplementedStub);
