...
RuntimeValue
Script_Parser_FindWordID(AGSEngine *vm, ScriptObject *,
...
RuntimeValue
Script_Parser_ParseText(AGSEngine *vm, ScriptObject *,
                        const Common::Array<RuntimeValue> &params) {
...
RuntimeValue Script_Parser_Said(AGSEngine *vm, ScriptObject *,
                                const Common::Array<RuntimeValue> &params) {
	ScriptString *text = (ScriptString *) params[0]._object;
	UNUSED(text);
...
RuntimeValue
Script_Parser_SaidUnknownWord(AGSEngine *vm, ScriptObject *,
                              const Common::Array<RuntimeValue> &params) {
	// FIXME
...
// Undocumented.
RuntimeValue Script_ParseText(AGSEngine *vm, ScriptObject *,
                              const Common::Array<RuntimeValue> &params) {
...
// Undocumented.
RuntimeValue Script_SaidUnknownWord(AGSEngine *vm, ScriptObject *,
                                    const Common::Array<RuntimeValue> &params) {
...
// Undocumented.
RuntimeValue Script_Said(AGSEngine *vm, ScriptObject *,
                         const Common::Array<RuntimeValue> &params) {
	ScriptString *text = (ScriptString *) params[0]._object;
	UNUSED(text);
...
static const ScriptSystemFunctionInfo ourFunctionList[] = {
    {"Parser::FindWordID^1", (ScriptAPIFunction *) &Script_Parser_FindWordID,
     "s", sotNone},
    {"Parser::ParseText^1", (ScriptAPIFunction *) &Script_Parser_ParseText, "s",
     sotNone},
    {"Parser::Said^1", (ScriptAPIFunction *) &Script_Parser_Said, "s", sotNone},
    {"Parser::SaidUnknownWord^0",
     (ScriptAPIFunction *) &Script_Parser_SaidUnknownWord, "", sotNone},
    {"ParseText", (ScriptAPIFunction *) &Script_ParseText, "s", sotNone},
    {"SaidUnknownWord", (ScriptAPIFunction *) &Script_SaidUnknownWord, "s",
     sotNone},
