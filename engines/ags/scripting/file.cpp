...
RuntimeValue Script_File_ReadInt(AGSEngine *vm, ScriptFile *self,
	...
	if (dataId != 'I')
		error("File::ReadInt: expected an integer, but got '%c' instead",
		      dataId);
...
static const ScriptSystemFunctionInfo ourFunctionList[] = {
    ...
    {"File::ReadRawLineBack^0",
     (ScriptAPIFunction *) &Script_File_ReadRawLineBack, "", sotFile},
    {"File::ReadStringBack^0",
     (ScriptAPIFunction *) &Script_File_ReadStringBack, "", sotFile},
