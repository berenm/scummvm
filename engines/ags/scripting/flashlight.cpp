...
RuntimeValue
Script_SetFlashlightTint(AGSEngine *vm, ScriptObject *,
...
RuntimeValue
Script_GetFlashlightTintRed(AGSEngine *vm, ScriptObject *,
                            const Common::Array<RuntimeValue> &params) {
	// FIXME
...
RuntimeValue
Script_GetFlashlightTintGreen(AGSEngine *vm, ScriptObject *,
                              const Common::Array<RuntimeValue> &params) {
	// FIXME
...
RuntimeValue
Script_GetFlashlightTintBlue(AGSEngine *vm, ScriptObject *,
                             const Common::Array<RuntimeValue> &params) {
	// FIXME
...
RuntimeValue
Script_GetFlashlightMinLightLevel(AGSEngine *vm, ScriptObject *,
                                  const Common::Array<RuntimeValue> &params) {
	// FIXME
...
RuntimeValue
Script_GetFlashlightMaxLightLevel(AGSEngine *vm, ScriptObject *,
                                  const Common::Array<RuntimeValue> &params) {
	// FIXME
...
RuntimeValue
Script_SetFlashlightDarkness(AGSEngine *vm, ScriptObject *,
                             const Common::Array<RuntimeValue> &params) {
...
RuntimeValue
Script_GetFlashlightDarkness(AGSEngine *vm, ScriptObject *,
                             const Common::Array<RuntimeValue> &params) {
	// FIXME
...
RuntimeValue
Script_SetFlashlightDarknessSize(AGSEngine *vm, ScriptObject *,
                                 const Common::Array<RuntimeValue> &params) {
...
RuntimeValue
Script_GetFlashlightDarknessSize(AGSEngine *vm, ScriptObject *,
                                 const Common::Array<RuntimeValue> &params) {
	// FIXME
...
RuntimeValue
Script_SetFlashlightBrightness(AGSEngine *vm, ScriptObject *,
                               const Common::Array<RuntimeValue> &params) {
	int lightLevel = params[0]._signedValue;
	UNUSED(lightLevel);
...
RuntimeValue
Script_GetFlashlightBrightness(AGSEngine *vm, ScriptObject *,
                               const Common::Array<RuntimeValue> &params) {
	// FIXME
...
RuntimeValue
Script_SetFlashlightBrightnessSize(AGSEngine *vm, ScriptObject *,
                                   const Common::Array<RuntimeValue> &params) {
	int size = params[0]._signedValue;
	UNUSED(size);
...
RuntimeValue
Script_GetFlashlightBrightnessSize(AGSEngine *vm, ScriptObject *,
                                   const Common::Array<RuntimeValue> &params) {
	// FIXME
...
RuntimeValue
Script_SetFlashlightPosition(AGSEngine *vm, ScriptObject *,
                             const Common::Array<RuntimeValue> &params) {
...
RuntimeValue
Script_GetFlashlightPositionX(AGSEngine *vm, ScriptObject *,
                              const Common::Array<RuntimeValue> &params) {
	// FIXME
...
RuntimeValue
Script_GetFlashlightPositionY(AGSEngine *vm, ScriptObject *,
                              const Common::Array<RuntimeValue> &params) {
	// FIXME
...
RuntimeValue
Script_SetFlashlightFollowMouse(AGSEngine *vm, ScriptObject *,
                                const Common::Array<RuntimeValue> &params) {
...
RuntimeValue
Script_GetFlashlightFollowMouse(AGSEngine *vm, ScriptObject *,
                                const Common::Array<RuntimeValue> &params) {
	// FIXME
...
// import void SetFlashlightFollowCharacter(int characterId, int dx, int dy, int
// horz, int vert) Set the flashlight to follow a character, with an offset and
// direction.
RuntimeValue
Script_SetFlashlightFollowCharacter(AGSEngine *vm, ScriptObject *,
                                    const Common::Array<RuntimeValue> &params) {
...
RuntimeValue
Script_GetFlashlightFollowCharacter(AGSEngine *vm, ScriptObject *,
                                    const Common::Array<RuntimeValue> &params) {
	// FIXME
...
RuntimeValue
Script_GetFlashlightCharacterDX(AGSEngine *vm, ScriptObject *,
                                const Common::Array<RuntimeValue> &params) {
	// FIXME
...
RuntimeValue
Script_GetFlashlightCharacterDY(AGSEngine *vm, ScriptObject *,
                                const Common::Array<RuntimeValue> &params) {
	// FIXME
...
RuntimeValue
Script_GetFlashlightCharacterHorz(AGSEngine *vm, ScriptObject *,
                                  const Common::Array<RuntimeValue> &params) {
	// FIXME
...
RuntimeValue
Script_GetFlashlightCharacterVert(AGSEngine *vm, ScriptObject *,
                                  const Common::Array<RuntimeValue> &params) {
	// FIXME
...
RuntimeValue
Script_SetFlashlightMask(AGSEngine *vm, ScriptObject *,
                         const Common::Array<RuntimeValue> &params) {
...
RuntimeValue
Script_GetFlashlightMask(AGSEngine *vm, ScriptObject *,
                         const Common::Array<RuntimeValue> &params) {
	// FIXME
...
static const ScriptSystemFunctionInfo ourFunctionList[] = {
    {"SetFlashlightTint", (ScriptAPIFunction *) &Script_SetFlashlightTint,
     "iii", sotNone},
    {"GetFlashlightTintRed", (ScriptAPIFunction *) &Script_GetFlashlightTintRed,
     "", sotNone},
    {"GetFlashlightTintGreen",
     (ScriptAPIFunction *) &Script_GetFlashlightTintGreen, "", sotNone},
    {"GetFlashlightTintBlue",
     (ScriptAPIFunction *) &Script_GetFlashlightTintBlue, "", sotNone},
    {"GetFlashlightMinLightLevel",
     (ScriptAPIFunction *) &Script_GetFlashlightMinLightLevel, "", sotNone},
    {"GetFlashlightMaxLightLevel",
     (ScriptAPIFunction *) &Script_GetFlashlightMaxLightLevel, "", sotNone},
    {"SetFlashlightDarkness",
     (ScriptAPIFunction *) &Script_SetFlashlightDarkness, "i", sotNone},
    {"GetFlashlightDarkness",
     (ScriptAPIFunction *) &Script_GetFlashlightDarkness, "", sotNone},
    {"SetFlashlightDarknessSize",
     (ScriptAPIFunction *) &Script_SetFlashlightDarknessSize, "i", sotNone},
    {"GetFlashlightDarknessSize",
     (ScriptAPIFunction *) &Script_GetFlashlightDarknessSize, "", sotNone},
    {"SetFlashlightBrightness",
     (ScriptAPIFunction *) &Script_SetFlashlightBrightness, "i", sotNone},
    {"GetFlashlightBrightness",
     (ScriptAPIFunction *) &Script_GetFlashlightBrightness, "", sotNone},
    {"SetFlashlightBrightnessSize",
     (ScriptAPIFunction *) &Script_SetFlashlightBrightnessSize, "i", sotNone},
    {"GetFlashlightBrightnessSize",
     (ScriptAPIFunction *) &Script_GetFlashlightBrightnessSize, "", sotNone},
    {"SetFlashlightPosition",
     (ScriptAPIFunction *) &Script_SetFlashlightPosition, "ii", sotNone},
    {"GetFlashlightPositionX",
     (ScriptAPIFunction *) &Script_GetFlashlightPositionX, "", sotNone},
    {"GetFlashlightPositionY",
     (ScriptAPIFunction *) &Script_GetFlashlightPositionY, "", sotNone},
    {"SetFlashlightFollowMouse",
     (ScriptAPIFunction *) &Script_SetFlashlightFollowMouse, "i", sotNone},
    {"GetFlashlightFollowMouse",
     (ScriptAPIFunction *) &Script_GetFlashlightFollowMouse, "", sotNone},
    {"SetFlashlightFollowCharacter",
     (ScriptAPIFunction *) &Script_SetFlashlightFollowCharacter, "iiiii",
     sotNone},
    {"GetFlashlightFollowCharacter",
     (ScriptAPIFunction *) &Script_GetFlashlightFollowCharacter, "", sotNone},
    {"GetFlashlightCharacterDX",
     (ScriptAPIFunction *) &Script_GetFlashlightCharacterDX, "", sotNone},
    {"GetFlashlightCharacterDY",
     (ScriptAPIFunction *) &Script_GetFlashlightCharacterDY, "", sotNone},
    {"GetFlashlightCharacterHorz",
     (ScriptAPIFunction *) &Script_GetFlashlightCharacterHorz, "", sotNone},
    {"GetFlashlightCharacterVert",
     (ScriptAPIFunction *) &Script_GetFlashlightCharacterVert, "", sotNone},
    {"SetFlashlightMask", (ScriptAPIFunction *) &Script_SetFlashlightMask, "i",
     sotNone},
    {"GetFlashlightMask", (ScriptAPIFunction *) &Script_GetFlashlightMask, "",
     sotNone},
};
