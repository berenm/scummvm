...
void addStringsSystemScripting(AGSEngine *vm) {
	...
	// String functions
	state->addSystemFunctionImport("String::IsNullOrEmpty^1",
	                               &Script_UnimplementedStub);
	state->addSystemFunctionImport("String::Append^1",
	                               &Script_UnimplementedStub);
	state->addSystemFunctionImport("String::AppendChar^1",
	                               &Script_UnimplementedStub);
	state->addSystemFunctionImport("String::CompareTo^2",
	                               &Script_UnimplementedStub);
	state->addSystemFunctionImport("String::Contains^1",
	                               &Script_UnimplementedStub);
	state->addSystemFunctionImport("String::Copy^0", &Script_UnimplementedStub);
	state->addSystemFunctionImport("String::EndsWith^2",
	                               &Script_UnimplementedStub);
	state->addSystemFunctionImport("String::Format^101",
	                               &Script_UnimplementedStub);
	state->addSystemFunctionImport("String::IndexOf^1",
	                               &Script_UnimplementedStub);
	state->addSystemFunctionImport("String::LowerCase^0",
	                               &Script_UnimplementedStub);
	state->addSystemFunctionImport("String::Replace^3",
	                               &Script_UnimplementedStub);
	state->addSystemFunctionImport("String::ReplaceCharAt^2",
	                               &Script_UnimplementedStub);
	state->addSystemFunctionImport("String::StartsWith^2",
	                               &Script_UnimplementedStub);
	state->addSystemFunctionImport("String::Substring^2",
	                               &Script_UnimplementedStub);
	state->addSystemFunctionImport("String::Truncate^1",
	                               &Script_UnimplementedStub);
	state->addSystemFunctionImport("String::UpperCase^0",
	                               &Script_UnimplementedStub);
	state->addSystemFunctionImport("String::get_AsFloat",
	                               &Script_UnimplementedStub);
	state->addSystemFunctionImport("String::get_AsInt",
	                               &Script_UnimplementedStub);
	state->addSystemFunctionImport("String::geti_Chars",
	                               &Script_UnimplementedStub);
	state->addSystemFunctionImport("String::get_Length",
	                               &Script_UnimplementedStub);
