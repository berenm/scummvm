...
static const ScriptSystemFunctionInfo ourFunctionList[] = {
    ...
    {"Hotspot::GetPropertyText^2",
     (ScriptAPIFunction *) &Script_Hotspot_GetPropertyText, "ss", sotNone},
    {"Hotspot::GetProperty^1",
     (ScriptAPIFunction *) &Script_Hotspot_GetProperty, "s", sotNone},
    {"Hotspot::GetTextProperty^1",
     (ScriptAPIFunction *) &Script_Hotspot_GetTextProperty, "s", sotNone},
    {"Hotspot::RunInteraction^1",
     (ScriptAPIFunction *) &Script_Hotspot_RunInteraction, "i", sotNone},
    ...
    {"Region::RunInteraction^1",
     (ScriptAPIFunction *) &Script_Region_RunInteraction, "i", sotNone},
    ...
    {"Region::get_LightLevel",
     (ScriptAPIFunction *) &Script_Region_get_LightLevel, "", sotNone},
    {"Region::set_LightLevel",
     (ScriptAPIFunction *) &Script_Region_set_LightLevel, "i", sotNone},
    {"Region::get_TintEnabled",
     (ScriptAPIFunction *) &Script_Region_get_TintEnabled, "", sotNone},
    {"Region::get_TintBlue", (ScriptAPIFunction *) &Script_Region_get_TintBlue,
     "", sotNone},
    {"Region::get_TintGreen",
     (ScriptAPIFunction *) &Script_Region_get_TintGreen, "", sotNone},
    {"Region::get_TintRed", (ScriptAPIFunction *) &Script_Region_get_TintRed,
     "", sotNone},
    {"Region::get_TintSaturation",
     (ScriptAPIFunction *) &Script_Region_get_TintSaturation, "", sotNone},
};
