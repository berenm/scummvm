...
// Undocumented.
RuntimeValue Script_GetTime(AGSEngine *vm, ScriptObject *,
...
// Undocumented.
RuntimeValue Script_GetRawTime(AGSEngine *vm, ScriptObject *,
                               const Common::Array<RuntimeValue> &params) {
	// FIXME
...
RuntimeValue Script_Maths_ArcCos(AGSEngine *vm, ScriptObject *,
                                 const Common::Array<RuntimeValue> &params) {
	float value = params[0]._floatValue;
	UNUSED(value);
...
RuntimeValue Script_Maths_ArcSin(AGSEngine *vm, ScriptObject *,
                                 const Common::Array<RuntimeValue> &params) {
	float value = params[0]._floatValue;
	UNUSED(value);
...
RuntimeValue Script_Maths_ArcTan(AGSEngine *vm, ScriptObject *,
                                 const Common::Array<RuntimeValue> &params) {
	float value = params[0]._floatValue;
	UNUSED(value);
...
RuntimeValue Script_Maths_ArcTan2(AGSEngine *vm, ScriptObject *,
                                  const Common::Array<RuntimeValue> &params) {
...
RuntimeValue Script_Maths_Cosh(AGSEngine *vm, ScriptObject *,
                               const Common::Array<RuntimeValue> &params) {
	float radians = params[0]._floatValue;
	UNUSED(radians);
...
RuntimeValue
Script_Maths_DegreesToRadians(AGSEngine *vm, ScriptObject *,
                              const Common::Array<RuntimeValue> &params) {
...
RuntimeValue Script_Maths_Exp(AGSEngine *vm, ScriptObject *,
                              const Common::Array<RuntimeValue> &params) {
...
RuntimeValue Script_Maths_Log(AGSEngine *vm, ScriptObject *,
                              const Common::Array<RuntimeValue> &params) {
	float x = params[0]._floatValue;
	UNUSED(x);
...
RuntimeValue Script_Maths_Log10(AGSEngine *vm, ScriptObject *,
                                const Common::Array<RuntimeValue> &params) {
	float x = params[0]._floatValue;
	UNUSED(x);
...
RuntimeValue
Script_Maths_RadiansToDegrees(AGSEngine *vm, ScriptObject *,
                              const Common::Array<RuntimeValue> &params) {
	float radians = params[0]._floatValue;
	UNUSED(radians);
...
RuntimeValue Script_Maths_Sinh(AGSEngine *vm, ScriptObject *,
                               const Common::Array<RuntimeValue> &params) {
	float radians = params[0]._floatValue;
	UNUSED(radians);
...
RuntimeValue Script_Maths_Sqrt(AGSEngine *vm, ScriptObject *,
                               const Common::Array<RuntimeValue> &params) {
	float value = params[0]._floatValue;
	UNUSED(value);
...
RuntimeValue Script_Maths_Tan(AGSEngine *vm, ScriptObject *,
                              const Common::Array<RuntimeValue> &params) {
	float radians = params[0]._floatValue;
	UNUSED(radians);
...
RuntimeValue Script_Maths_Tanh(AGSEngine *vm, ScriptObject *,
                               const Common::Array<RuntimeValue> &params) {
	float radians = params[0]._floatValue;
	UNUSED(radians);
...
RuntimeValue
Script_DateTime_get_Now(AGSEngine *vm, ScriptObject *,
                        const Common::Array<RuntimeValue> &params) {
	// FIXME
...
RuntimeValue
Script_DateTime_get_Year(AGSEngine *vm, DateTime *self,
                         const Common::Array<RuntimeValue> &params) {
	// FIXME
...
RuntimeValue
Script_DateTime_get_Month(AGSEngine *vm, DateTime *self,
                          const Common::Array<RuntimeValue> &params) {
	// FIXME
...
RuntimeValue
Script_DateTime_get_DayOfMonth(AGSEngine *vm, DateTime *self,
                               const Common::Array<RuntimeValue> &params) {
	// FIXME
...
RuntimeValue
Script_DateTime_get_Hour(AGSEngine *vm, DateTime *self,
                         const Common::Array<RuntimeValue> &params) {
	// FIXME
...
RuntimeValue
Script_DateTime_get_Minute(AGSEngine *vm, DateTime *self,
                           const Common::Array<RuntimeValue> &params) {
	// FIXME
...
RuntimeValue
Script_DateTime_get_Second(AGSEngine *vm, DateTime *self,
                           const Common::Array<RuntimeValue> &params) {
	// FIXME
...
RuntimeValue
Script_DateTime_get_RawTime(AGSEngine *vm, DateTime *self,
                            const Common::Array<RuntimeValue> &params) {
	// FIXME
...
static const ScriptSystemFunctionInfo ourFunctionList[] = {
    ...
    {"Maths::ArcCos^1", (ScriptAPIFunction *) &Script_Maths_ArcCos, "f",
     sotNone},
    {"Maths::ArcSin^1", (ScriptAPIFunction *) &Script_Maths_ArcSin, "f",
     sotNone},
    {"Maths::ArcTan^1", (ScriptAPIFunction *) &Script_Maths_ArcTan, "f",
     sotNone},
    {"Maths::ArcTan2^2", (ScriptAPIFunction *) &Script_Maths_ArcTan2, "ff",
     sotNone},
    {"Maths::Cos^1", (ScriptAPIFunction *) &Script_Maths_Cos, "f", sotNone},
    {"Maths::Cosh^1", (ScriptAPIFunction *) &Script_Maths_Cosh, "f", sotNone},
    {"Maths::DegreesToRadians^1",
     (ScriptAPIFunction *) &Script_Maths_DegreesToRadians, "f", sotNone},
    ...
    {"Maths::RadiansToDegrees^1",
     (ScriptAPIFunction *) &Script_Maths_RadiansToDegrees, "f", sotNone},
    {"Maths::RaiseToPower^2", (ScriptAPIFunction *) &Script_Maths_RaiseToPower,
     "ff", sotNone},
    ...
    {"DateTime::get_Now", (ScriptAPIFunction *) &Script_DateTime_get_Now, "",
     sotNone},
    {"DateTime::get_Year", (ScriptAPIFunction *) &Script_DateTime_get_Year, "",
     sotDateTime},
    {"DateTime::get_Month", (ScriptAPIFunction *) &Script_DateTime_get_Month,
     "", sotDateTime},
    {"DateTime::get_DayOfMonth",
     (ScriptAPIFunction *) &Script_DateTime_get_DayOfMonth, "", sotDateTime},
    {"DateTime::get_Hour", (ScriptAPIFunction *) &Script_DateTime_get_Hour, "",
     sotDateTime},
    {"DateTime::get_Minute", (ScriptAPIFunction *) &Script_DateTime_get_Minute,
     "", sotDateTime},
    {"DateTime::get_Second", (ScriptAPIFunction *) &Script_DateTime_get_Second,
     "", sotDateTime},
    {"DateTime::get_RawTime",
     (ScriptAPIFunction *) &Script_DateTime_get_RawTime, "", sotDateTime},
};
