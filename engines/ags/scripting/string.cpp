...
RuntimeValue Script_String_Format(AGSEngine *vm, ScriptObject *,
...
RuntimeValue Script_String_Append(AGSEngine *vm, ScriptString *self,
                                  const Common::Array<RuntimeValue> &params) {
	ScriptString *appendText = (ScriptString *) params[0]._object;

	RuntimeValue ret =
	    new ScriptMutableString(self->getString() + appendText->getString());
	ret._object->DecRef();
	return ret;
}
...
RuntimeValue
Script_String_AppendChar(AGSEngine *vm, ScriptString *self,
                         const Common::Array<RuntimeValue> &params) {
...
// String: import int CompareTo(const string otherString, bool caseSensitive =
// false) Compares this string to the other string.
RuntimeValue
Script_String_CompareTo(AGSEngine *vm, ScriptString *self,
                        const Common::Array<RuntimeValue> &params) {
...
RuntimeValue Script_String_Contains(AGSEngine *vm, ScriptString *self,
                                    const Common::Array<RuntimeValue> &params) {
...
RuntimeValue Script_String_Copy(AGSEngine *vm, ScriptString *self,
                                const Common::Array<RuntimeValue> &params) {
...
// String: import bool EndsWith(const string endsWithText, bool caseSensitive =
// false) Checks whether this string ends with the specified text.
RuntimeValue Script_String_EndsWith(AGSEngine *vm, ScriptString *self,
                                    const Common::Array<RuntimeValue> &params) {
...
RuntimeValue
Script_String_LowerCase(AGSEngine *vm, ScriptString *self,
                        const Common::Array<RuntimeValue> &params) {
...
// String: import String Replace(const string lookForText, const string
// replaceWithText, bool caseSensitive = false) Returns a copy of this string
// with all occurrences of LookForText replaced with ReplaceWithText
RuntimeValue Script_String_Replace(AGSEngine *vm, ScriptString *self,
                                   const Common::Array<RuntimeValue> &params) {
...
// caseSensitive = false) Checks whether this string starts with the specified
// text.
RuntimeValue
Script_String_StartsWith(AGSEngine *vm, ScriptString *self,
                         const Common::Array<RuntimeValue> &params) {
...
Script_String_Substring(AGSEngine *vm, ScriptString *self,
	...
	if (index + length > string.size())
		error("String::Substring: invalid length (%d, from index %d on string "
		      "of length %d)",
...
// Truncates the string down to the specified length by removing characters from
// the end.
...
RuntimeValue
Script_String_UpperCase(AGSEngine *vm, ScriptString *self,
                        const Common::Array<RuntimeValue> &params) {
	Common::String string = self->getString();
	string.toUppercase();
	RuntimeValue ret = new ScriptMutableString(string);
...
RuntimeValue
Script_String_get_AsFloat(AGSEngine *vm, ScriptString *self,
                          const Common::Array<RuntimeValue> &params) {
	// FIXME
...
RuntimeValue
Script_String_get_AsInt(AGSEngine *vm, ScriptString *self,
                        const Common::Array<RuntimeValue> &params) {
...
RuntimeValue
Script_String_geti_Chars(AGSEngine *vm, ScriptString *self,
                         const Common::Array<RuntimeValue> &params) {
	uint index = params[0]._value;

	Common::String string = self->getString();
	if (index >= string.size())
		error("String::geti_Chars: char %d is too high (only have %d chars)",
		      index, string.size());
...
// String function.
RuntimeValue Script_StrFormat(AGSEngine *vm, ScriptObject *,
                              const Common::Array<RuntimeValue> &params) {
	ScriptString *dest = (ScriptString *) params[0]._object;
	UNUSED(dest);
...
// String function.
RuntimeValue Script_StrSetCharAt(AGSEngine *vm, ScriptObject *,
                                 const Common::Array<RuntimeValue> &params) {
	ScriptString *string = (ScriptString *) params[0]._object;
	uint position = params[1]._value;
	...
	if (position > realString.size())
		error("StrSetCharAt: position %d is beyond string length %d", position,
		      realString.size());
...
// String function.
RuntimeValue Script_StrToUpperCase(AGSEngine *vm, ScriptObject *,
                                   const Common::Array<RuntimeValue> &params) {
	ScriptString *string = (ScriptString *) params[0]._object;
...
// String function.
RuntimeValue Script_StrContains(AGSEngine *vm, ScriptObject *,
                                const Common::Array<RuntimeValue> &params) {
...
static const ScriptSystemFunctionInfo ourFunctionList[] = {
    ...
    {"String::AppendChar^1", (ScriptAPIFunction *) &Script_String_AppendChar,
     "c", sotString},
    {"String::CompareTo^2", (ScriptAPIFunction *) &Script_String_CompareTo,
     "si", sotString},
    {"String::Contains^1", (ScriptAPIFunction *) &Script_String_Contains, "s",
     sotString},
    {"String::Copy^0", (ScriptAPIFunction *) &Script_String_Copy, "",
     sotString},
    {"String::EndsWith^2", (ScriptAPIFunction *) &Script_String_EndsWith, "si",
     sotString},
    {"String::IndexOf^1", (ScriptAPIFunction *) &Script_String_IndexOf, "s",
     sotString},
    {"String::LowerCase^0", (ScriptAPIFunction *) &Script_String_LowerCase, "",
     sotString},
    {"String::Replace^3", (ScriptAPIFunction *) &Script_String_Replace, "ssi",
     sotString},
    {"String::ReplaceCharAt^2",
     (ScriptAPIFunction *) &Script_String_ReplaceCharAt, "ic", sotString},
    {"String::StartsWith^2", (ScriptAPIFunction *) &Script_String_StartsWith,
     "si", sotString},
    {"String::Substring^2", (ScriptAPIFunction *) &Script_String_Substring,
     "ii", sotString},
    {"String::Truncate^1", (ScriptAPIFunction *) &Script_String_Truncate, "i",
     sotString},
    {"String::UpperCase^0", (ScriptAPIFunction *) &Script_String_UpperCase, "",
     sotString},
    {"String::get_AsFloat", (ScriptAPIFunction *) &Script_String_get_AsFloat,
     "", sotString},
    {"String::get_AsInt", (ScriptAPIFunction *) &Script_String_get_AsInt, "",
     sotString},
    {"String::geti_Chars", (ScriptAPIFunction *) &Script_String_geti_Chars, "i",
     sotString},
    {"String::get_Length", (ScriptAPIFunction *) &Script_String_get_Length, "",
     sotString},
    ...
    {"StrSetCharAt", (ScriptAPIFunction *) &Script_StrSetCharAt, "sii",
     sotNone},
    {"StrToLowerCase", (ScriptAPIFunction *) &Script_StrToLowerCase, "s",
     sotNone},
    {"StrToUpperCase", (ScriptAPIFunction *) &Script_StrToUpperCase, "s",
     sotNone},
