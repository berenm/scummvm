...
void addInventorySystemScripting(GlobalScriptState *state) {
	...
	state->addSystemFunctionImport("InventoryItem::GetAtScreenXY^2",
	                               &Script_UnimplementedStub);
	state->addSystemFunctionImport("InventoryItem::IsInteractionAvailable^1",
	                               &Script_UnimplementedStub);
	state->addSystemFunctionImport("InventoryItem::GetName^1",
	                               &Script_UnimplementedStub);
	state->addSystemFunctionImport("InventoryItem::GetProperty^1",
	                               &Script_UnimplementedStub);
	state->addSystemFunctionImport("InventoryItem::GetPropertyText^2",
	                               &Script_UnimplementedStub);
	state->addSystemFunctionImport("InventoryItem::GetTextProperty^1",
	                               &Script_UnimplementedStub);
	state->addSystemFunctionImport("InventoryItem::RunInteraction^1",
	                               &Script_UnimplementedStub);
	state->addSystemFunctionImport("InventoryItem::SetName^1",
	                               &Script_UnimplementedStub);
	state->addSystemFunctionImport("InventoryItem::get_CursorGraphic",
	                               &Script_UnimplementedStub);
	state->addSystemFunctionImport("InventoryItem::set_CursorGraphic",
	                               &Script_UnimplementedStub);
	state->addSystemFunctionImport("InventoryItem::get_Graphic",
	                               &Script_UnimplementedStub);
	state->addSystemFunctionImport("InventoryItem::set_Graphic",
	                               &Script_UnimplementedStub);
	state->addSystemFunctionImport("InventoryItem::get_ID",
	                               &Script_UnimplementedStub);
	state->addSystemFunctionImport("InventoryItem::get_Name",
	                               &Script_UnimplementedStub);
	state->addSystemFunctionImport("InventoryItem::set_Name",
	                               &Script_UnimplementedStub);
	...
	state->addSystemFunctionImport("GetInvPropertyText",
	                               &Script_UnimplementedStub);
	state->addSystemFunctionImport("RunInventoryInteraction",
	                               &Script_UnimplementedStub);
