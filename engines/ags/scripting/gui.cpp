...
static const ScriptSystemFunctionInfo ourFunctionList[] = {
    ...
    {"Button::get_ClipImage",
     (ScriptAPIFunction *) &Script_Button_get_ClipImage, "", sotNone},
    {"Button::set_ClipImage",
     (ScriptAPIFunction *) &Script_Button_set_ClipImage, "i", sotNone},
    ...
    {"Button::get_MouseOverGraphic",
     (ScriptAPIFunction *) &Script_Button_get_MouseOverGraphic, "", sotNone},
    {"Button::set_MouseOverGraphic",
     (ScriptAPIFunction *) &Script_Button_set_MouseOverGraphic, "i", sotNone},
    {"Button::get_NormalGraphic",
     (ScriptAPIFunction *) &Script_Button_get_NormalGraphic, "", sotNone},
    {"Button::set_NormalGraphic",
     (ScriptAPIFunction *) &Script_Button_set_NormalGraphic, "i", sotNone},
    {"Button::get_PushedGraphic",
     (ScriptAPIFunction *) &Script_Button_get_PushedGraphic, "", sotNone},
    {"Button::set_PushedGraphic",
     (ScriptAPIFunction *) &Script_Button_set_PushedGraphic, "i", sotNone},
    {"Button::get_TextColor",
     (ScriptAPIFunction *) &Script_Button_get_TextColor, "", sotNone},
    {"Button::set_TextColor",
     (ScriptAPIFunction *) &Script_Button_set_TextColor, "i", sotNone},
    ...
    {"Slider::get_BackgroundGraphic",
     (ScriptAPIFunction *) &Script_Slider_get_BackgroundGraphic, "", sotNone},
    {"Slider::set_BackgroundGraphic",
     (ScriptAPIFunction *) &Script_Slider_set_BackgroundGraphic, "i", sotNone},
    {"Slider::get_HandleGraphic",
     (ScriptAPIFunction *) &Script_Slider_get_HandleGraphic, "", sotNone},
    {"Slider::set_HandleGraphic",
     (ScriptAPIFunction *) &Script_Slider_set_HandleGraphic, "i", sotNone},
    {"Slider::get_HandleOffset",
     (ScriptAPIFunction *) &Script_Slider_get_HandleOffset, "", sotNone},
    {"Slider::set_HandleOffset",
     (ScriptAPIFunction *) &Script_Slider_set_HandleOffset, "i", sotNone},
    ...
    {"TextBox::get_TextColor",
     (ScriptAPIFunction *) &Script_TextBox_get_TextColor, "", sotNone},
    {"TextBox::set_TextColor",
     (ScriptAPIFunction *) &Script_TextBox_set_TextColor, "i", sotNone},
    {"InvWindow::ScrollDown^0",
     (ScriptAPIFunction *) &Script_InvWindow_ScrollDown, "", sotNone},
    {"InvWindow::ScrollUp^0", (ScriptAPIFunction *) &Script_InvWindow_ScrollUp,
     "", sotNone},
    {"InvWindow::get_CharacterToUse",
     (ScriptAPIFunction *) &Script_InvWindow_get_CharacterToUse, "", sotNone},
    {"InvWindow::set_CharacterToUse",
     (ScriptAPIFunction *) &Script_InvWindow_set_CharacterToUse, "o", sotNone},
    {"InvWindow::geti_ItemAtIndex",
     (ScriptAPIFunction *) &Script_InvWindow_geti_ItemAtIndex, "i", sotNone},
    {"InvWindow::get_ItemCount",
     (ScriptAPIFunction *) &Script_InvWindow_get_ItemCount, "", sotNone},
    {"InvWindow::get_ItemHeight",
     (ScriptAPIFunction *) &Script_InvWindow_get_ItemHeight, "", sotNone},
    {"InvWindow::set_ItemHeight",
     (ScriptAPIFunction *) &Script_InvWindow_set_ItemHeight, "i", sotNone},
    {"InvWindow::get_ItemWidth",
     (ScriptAPIFunction *) &Script_InvWindow_get_ItemWidth, "", sotNone},
    {"InvWindow::set_ItemWidth",
     (ScriptAPIFunction *) &Script_InvWindow_set_ItemWidth, "i", sotNone},
    {"InvWindow::get_TopItem",
     (ScriptAPIFunction *) &Script_InvWindow_get_TopItem, "", sotNone},
    {"InvWindow::set_TopItem",
     (ScriptAPIFunction *) &Script_InvWindow_set_TopItem, "i", sotNone},
    {"InvWindow::get_ItemsPerRow",
     (ScriptAPIFunction *) &Script_InvWindow_get_ItemsPerRow, "", sotNone},
    {"InvWindow::get_RowCount",
     (ScriptAPIFunction *) &Script_InvWindow_get_RowCount, "", sotNone},
    ...
    {"ListBox::FillDirList^1",
     (ScriptAPIFunction *) &Script_ListBox_FillDirList, "s", sotNone},
    {"ListBox::FillSaveGameList^0",
     (ScriptAPIFunction *) &Script_ListBox_FillSaveGameList, "", sotNone},
    {"ListBox::GetItemAtLocation^2",
     (ScriptAPIFunction *) &Script_ListBox_GetItemAtLocation, "ii", sotNone},
    {"ListBox::GetItemText^2",
     (ScriptAPIFunction *) &Script_ListBox_GetItemText, "is", sotNone},
    {"ListBox::SetItemText^2",
     (ScriptAPIFunction *) &Script_ListBox_SetItemText, "is", sotNone},
    {"ListBox::InsertItemAt^2",
     (ScriptAPIFunction *) &Script_ListBox_InsertItemAt, "is", sotNone},
    ...
    {"ListBox::get_HideBorder",
     (ScriptAPIFunction *) &Script_ListBox_get_HideBorder, "", sotNone},
    {"ListBox::set_HideBorder",
     (ScriptAPIFunction *) &Script_ListBox_set_HideBorder, "i", sotNone},
    {"ListBox::get_HideScrollArrows",
     (ScriptAPIFunction *) &Script_ListBox_get_HideScrollArrows, "", sotNone},
    {"ListBox::set_HideScrollArrows",
     (ScriptAPIFunction *) &Script_ListBox_set_HideScrollArrows, "i", sotNone},
    {"ListBox::get_ItemCount",
     (ScriptAPIFunction *) &Script_ListBox_get_ItemCount, "", sotNone},
    ...
    {"ListBox::get_RowCount",
     (ScriptAPIFunction *) &Script_ListBox_get_RowCount, "", sotNone},
    {"ListBox::geti_SaveGameSlots",
     (ScriptAPIFunction *) &Script_ListBox_geti_SaveGameSlots, "i", sotNone},
    {"ListBox::get_SelectedIndex",
     (ScriptAPIFunction *) &Script_ListBox_get_SelectedIndex, "", sotNone},
    {"ListBox::set_SelectedIndex",
     (ScriptAPIFunction *) &Script_ListBox_set_SelectedIndex, "i", sotNone},
    ...
    {"GUI::SetPosition^2", (ScriptAPIFunction *) &Script_GUI_SetPosition, "ii",
     sotNone},
    {"GUI::SetSize^2", (ScriptAPIFunction *) &Script_GUI_SetSize, "ii",
     sotNone},
    {"GUI::get_BackgroundGraphic",
     (ScriptAPIFunction *) &Script_GUI_get_BackgroundGraphic, "", sotNone},
    {"GUI::set_BackgroundGraphic",
     (ScriptAPIFunction *) &Script_GUI_set_BackgroundGraphic, "i", sotNone},
    ...
    {"GUI::get_ControlCount",
     (ScriptAPIFunction *) &Script_GUI_get_ControlCount, "", sotNone},
    ...
    {"GUI::get_Transparency",
     (ScriptAPIFunction *) &Script_GUI_get_Transparency, "", sotNone},
    {"GUI::set_Transparency",
     (ScriptAPIFunction *) &Script_GUI_set_Transparency, "i", sotNone},
    {"GUI::get_Visible", (ScriptAPIFunction *) &Script_GUI_get_Visible, "",
     sotNone},
    {"GUI::set_Visible", (ScriptAPIFunction *) &Script_GUI_set_Visible, "i",
     sotNone},
    {"GUI::get_Width", (ScriptAPIFunction *) &Script_GUI_get_Width, "",
     sotNone},
