...
void addAudioSystemScripting(AGSEngine *vm) {
	...
	state->addSystemFunctionImport("Game::StopSound^1",
	                               &Script_UnimplementedStub);
	state->addSystemFunctionImport("System::get_Volume",
	                               &Script_UnimplementedStub);
	state->addSystemFunctionImport("System::set_Volume",
	                               &Script_UnimplementedStub);

	// static audio(/video) functions
	state->addSystemFunctionImport("GetCurrentMusic",
	                               &Script_UnimplementedStub);
	state->addSystemFunctionImport("GetMIDIPosition",
	                               &Script_UnimplementedStub);
	state->addSystemFunctionImport("GetMP3PosMillis",
	                               &Script_UnimplementedStub);
	state->addSystemFunctionImport("IsChannelPlaying",
	                               &Script_UnimplementedStub);
	state->addSystemFunctionImport("IsMusicPlaying", &Script_UnimplementedStub);
	state->addSystemFunctionImport("IsMusicVoxAvailable",
	                               &Script_UnimplementedStub);
	...
	state->addSystemFunctionImport("PlayAmbientSound",
	                               &Script_UnimplementedStub);
	...
	state->addSystemFunctionImport("PlayMusicQueued",
	                               &Script_UnimplementedStub);
	...
	state->addSystemFunctionImport("SeekMIDIPosition",
	                               &Script_UnimplementedStub);
	state->addSystemFunctionImport("SeekMODPattern", &Script_UnimplementedStub);
	state->addSystemFunctionImport("SeekMP3PosMillis",
	                               &Script_UnimplementedStub);
	state->addSystemFunctionImport("SetDigitalMasterVolume",
	                               &Script_UnimplementedStub);
	state->addSystemFunctionImport("SetMusicMasterVolume",
	                               &Script_UnimplementedStub);
	...
	state->addSystemFunctionImport("SetSpeechVolume",
	                               &Script_UnimplementedStub);
	state->addSystemFunctionImport("StopAmbientSound",
	                               &Script_UnimplementedStub);
