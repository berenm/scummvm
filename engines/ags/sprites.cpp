...
Graphics::Surface *SpriteSet::getSprite(uint32 spriteId) {
	...
	case 3: format = Graphics::PixelFormat(3, 8, 8, 8, 0, 16, 8, 0, 0); break;
	default: error("SpriteSet::getSprite: invalid sprite depth %d", spriteId);
	}
	...
	if (_spritesAreCompressed) {
		...
		case 1:
			...
			break;
		case 2:
		case 3: error("high-depth sprites unimplemented"); // FIXME: !!!
		}
	} else {
