...
#define SCMD_LOADSPOFFS \
	51                    // MAR = SP - arg1 (optimization for local var access)
...
#define SCMD_STRINGSEQUAL \
	65 // (char*)reg1 == (char*)reg2   reg1=1 if true, =0 if not
...
#define SCMD_NEWARRAY \
	72 // reg1 = new array of reg1 elements, each of size arg2 (arg3=managed
	   // type?)
