...
AGSEngine::AGSEngine(OSystem *syst, const AGSGameDescription *gameDesc) :
    ...
    _needsUpdate(true), _guiNeedsUpdate(true), _startingRoom(0xffffffff),
    ...
    _inNewRoomState(kNewRoomStateNone), _newRoomStateWas(kNewRoomStateNone),
    _inEntersScreenCounter(0), _blockingUntil(kUntilNothing),
