...
public:
	...
	void animate(uint loopId, uint speed, uint repeat,
	             bool noIdleOverride = false, uint direction = 0);
	...
	uint16 _zoom;
	int16 _xWas, _yWas; // next frame's X/Y position, during interpolation for
